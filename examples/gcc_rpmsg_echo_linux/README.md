 ...
 * GCC supports the [latest language](https://gcc.gnu.org/onlinedocs/gcc-15.2.0/gcc/Standards.html#C-Language) standards (e.g. C23 and C2Y), and numerous [extensions](https://gcc.gnu.org/onlinedocs/gcc/C-Extensions.html).
 ...
 * GCC has a powerful [extension](https://gcc.gnu.org/onlinedocs/gcc/Extended-Asm.html) for writing snippets of inline assembly inside C functions.
